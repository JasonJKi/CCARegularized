...
load('res/demo_data/ddaEEGProcessed.mat','EEG') 
nSubjects=size(EEG,3); nChannels=size(EEG,2); 

% load stimulus data
load('res/demo_data/ddaVideoFeaturesProcessed.mat','X','fs'); % stimulus info: scene from Dog Day Afternoon (Sidney Lumet, 1975), t = 325.8750s, fs =24
